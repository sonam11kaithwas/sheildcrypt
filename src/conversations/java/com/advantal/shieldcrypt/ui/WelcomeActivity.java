...
import com.advantal.shieldcrypt.databinding.ActivityWelcomeBinding;
...
import com.advantal.shieldcrypt.utils_pkg.InstallReferrerUtils;
...
public class WelcomeActivity extends XmppActivity implements XmppConnectionService.OnAccountCreated, KeyChainAliasCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        binding.agreeContinueBtn.setOnClickListener(v -> {

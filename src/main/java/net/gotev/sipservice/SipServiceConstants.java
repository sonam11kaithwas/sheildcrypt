...
public interface SipServiceConstants {
    ...
    String ACTION_CALL_SPEAKER = "callSetSpeaker";
    String PARAM_CALL_TYPE = "callType";
    ...
    String PARAM_IS_FROM_WAY_FOR_VERSION_S = "isNotiAndroidS";
    ...
    int setFpsNum = 30;
    int setFpsDenum = 1;
    int setAvgBps = 512000;
    int setMaxBps = 1024000;

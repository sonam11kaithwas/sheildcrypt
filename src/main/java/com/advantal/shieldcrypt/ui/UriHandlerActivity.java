...
import com.advantal.shieldcrypt.databinding.ActivityUriHandlerBinding;
...
import com.advantal.shieldcrypt.utils.ProvisioningUtils;
...
public class UriHandlerActivity extends AppCompatActivity {
    ...
    private static Class<?> findShareViaAccountClass() {
        try {
            return Class.forName("com.advantal.shieldcrypt.ui.ShareViaAccountActivity");

...
import com.advantal.shieldcrypt.databinding.DialogQuickeditBinding;
...
import com.advantal.shieldcrypt.entities.Presences;
import com.advantal.shieldcrypt.services.AvatarService;
import com.advantal.shieldcrypt.services.BarcodeProvider;
import com.advantal.shieldcrypt.services.EmojiInitializationService;
...
import com.advantal.shieldcrypt.services.XmppConnectionService.XmppConnectionBinder;
...
public abstract class XmppActivity extends ActionBarActivity {
    ...
    public void getCon(){
        ...
        List<Conversation> conversationList= xmppConnectionService.getConversations();
//        for ()
        Log.e("","");
    }
...
//                    jid = Jid.ofEscaped(MySharedPreferences.getSharedprefInstance().getLoginData().mobileNumber + "@" + MySharedPreferences.getSharedprefInstance().getLoginData().xmpip, Config.DOMAIN_LOCK, null);
//                } else {
//                    jid = Jid.ofEscaped(MySharedPreferences.getSharedprefInstance().getLoginData().mobileNumber + "@" + MySharedPreferences.Companion.getSharedprefInstance().getXSip();
//                }
...
////                        conversation = xmppConnectionService.findOrCreateConversation(account.getRoster().getContacts().get(i).getAccount(),
////                                account.getRoster().getContacts().get(i).getJid(), false, true);
...
//    }
    ...
    private void switchToConversation(@NonNull Conversation conversation, String text, boolean asQuote, String nick, boolean pm, boolean doNotAppend) {
//        MYUUID=conversation.getUuid();
        Log.e("","");
...
//        intent.putExtra("STARTCHAT", conversation.getUuid());

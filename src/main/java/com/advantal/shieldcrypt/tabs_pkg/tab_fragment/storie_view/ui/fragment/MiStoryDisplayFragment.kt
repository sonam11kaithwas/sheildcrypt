package com.advantal.shieldcrypt.tabs_pkg.tab_fragment.storie_view.ui.fragment
...
import com.advantal.shieldcrypt.databinding.FragmentMiStoryDisplayBinding
import com.advantal.shieldcrypt.tabs_pkg.tab_fragment.storie_view.common.INITIAL_STORY_INDEX
import com.advantal.shieldcrypt.tabs_pkg.tab_fragment.storie_view.common.extension.*
import com.advantal.shieldcrypt.tabs_pkg.tab_fragment.storie_view.common.gesturedetector.GestureListener
import com.advantal.shieldcrypt.tabs_pkg.tab_fragment.storie_view.common.gesturedetector.MiGestureDetector
...
import com.advantal.shieldcrypt.tabs_pkg.tab_fragment.storie_view.ui.activity.MiStoryDisplayViewModel
    ...
    private fun loadInitialData() {
        ...
        if (isResumed && isVisible) {
            mStories[INITIAL_STORY_INDEX].let {
                if (it.name!=null) {
                    mBinding.tvName.text = it.name!!.capitalize()
                }

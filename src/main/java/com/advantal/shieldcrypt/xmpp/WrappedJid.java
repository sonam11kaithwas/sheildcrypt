...
public class WrappedJid implements com.advantal.shieldcrypt.xmpp.Jid {
    ...
    @Override
    public com.advantal.shieldcrypt.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public com.advantal.shieldcrypt.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public com.advantal.shieldcrypt.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(com.advantal.shieldcrypt.xmpp.Jid jid) {

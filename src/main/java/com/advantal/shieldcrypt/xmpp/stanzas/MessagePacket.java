...
public class MessagePacket extends AbstractAcknowledgeableStanza {
    ...
    public LocalizedContent getSubject() {
        return findInternationalizedChildContentInDefaultNamespace("subject");
    }

    public LocalizedContent getGrpUseNm() {
        return findInternationalizedChildContentInDefaultNamespace("grpusrnm");
    }

    public void setSubjct(String text) {
        this.children.remove(findChild("subject"));
        Element body = new Element("subject");
        body.setContent(text);
        this.children.add(0, body);
    }

    public void setGrpUsrNm(String text) {
        this.children.remove(findChild("grpusrnm"));
        Element body = new Element("grpusrnm");
        body.setContent(text);
        this.children.add(0, body);
    }

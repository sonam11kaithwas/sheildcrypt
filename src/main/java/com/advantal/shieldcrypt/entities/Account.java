...
import com.advantal.shieldcrypt.crypto.axolotl.XmppAxolotlSession;
import com.advantal.shieldcrypt.crypto.sasl.ChannelBinding;
import com.advantal.shieldcrypt.crypto.sasl.ChannelBindingMechanism;
import com.advantal.shieldcrypt.crypto.sasl.HashedToken;
import com.advantal.shieldcrypt.crypto.sasl.HashedTokenSha256;
import com.advantal.shieldcrypt.crypto.sasl.HashedTokenSha512;
...
public class Account extends AbstractEntity implements AvatarService.Avatarable {
    ...
    public com.advantal.shieldcrypt.entities.Bookmark getBookmark(final Jid jid) {
        synchronized (this.bookmarks) {

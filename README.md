...
<p align="center">
    <a href="https://play.google.com/store/apps/details?id=com.advantal.shieldcrypt&amp;referrer=utm_source%3Dgithub">
...
Google [Play Store](https://play.google.com/store/apps/details?id=com.advantal.shieldcrypt&referrer=utm_source%3Dgithub).
...
<a name="beta"></a>
#### Beta testing
If you bought the App on [Google Play](https://play.google.com/store/apps/details?id=com.advantal.shieldcrypt)
you can get access to the the latest beta version by signing up using [this link](https://play.google.com/apps/testing/com.advantal.shieldcrypt).
...
In the file `build.gradle`, find the line `applicationId "com.advantal.shieldcrypt"` , and replace it with `applicationId "my.conversations.fork"`, also below replace "Conversations" appName with "MyCFork".
